...
public class GestoreDB {
	...
	private Prodotti_CarrelloDAO prodotti_carrelloDAO;
	...
	private GestoreDB() {
		...
		richiestaDAO.load();
		prodotti_carrelloDAO = Prodotti_CarrelloDAO.getInstance();
		prodotti_carrelloDAO.load();
	...
	public  List<Prodotti_Carrello> getP_Carrello(){
		return prodotti_carrelloDAO.getP_Carrello() ;
	}
